...
public class ParamValidateUtil {
	...
	public static void validateEmpty(MultipartFile[] multipartFiles,String message) throws ParamNotValidException{
	...
	// 正整数校验
		public static void validatePositive(Double param, String message) throws ParamNotValidException {
			if (param == null || param < 0) {
				throw new ParamNotValidException(message);
			}
		}
	...
	public static void validateIsNumber(String str,String message) throws ParamNotValidException{
